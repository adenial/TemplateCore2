...
namespace TemplateCore.Repository
{
    ...
    where U : DbContext, IDisposable
  {
    ...
    IRepository<Microsoft.AspNetCore.Identity.IdentityRole> RoleRepository { get; }

    /// <summary>
    /// Gets the use roles repository.
    /// </summary>
    /// <value>The use roles repository.</value>
    IRepository<Microsoft.AspNetCore.Identity.IdentityUserRole<string>> UseRolesRepository { get; }

    /// <summary>
    /// Gets role claims repository
    /// </summary>
    /// <value>The role claims repository.</value>
    IRepository<Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>> RoleClaimsRepository { get; }
