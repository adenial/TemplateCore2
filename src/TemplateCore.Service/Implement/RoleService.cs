...
namespace TemplateCore.Service.Implement
{
  ...
  public class RoleService : IRoleService
  {
    ...
    {
      var newIdentityRole = new Microsoft.AspNetCore.Identity.IdentityRole { Name = name, NormalizedName = name };

      this.unitOfWork.RoleRepository.Insert(newIdentityRole);

      foreach (var claim in claims)
      {
        this.unitOfWork.RoleClaimsRepository.Insert(new Microsoft.AspNetCore.Identity.IdentityRoleClaim<string> { RoleId = newIdentityRole.Id, ClaimType = claim.Type, ClaimValue = claim.Value });
      }
