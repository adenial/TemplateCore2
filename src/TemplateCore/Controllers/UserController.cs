  ...
  public class UserController : Controller
  {
    ...
    public IActionResult Edit(UserEditViewModel model)
    {
      if (this.ModelState.IsValid)
      {
        ...
        List<Microsoft.AspNetCore.Identity.IdentityUserRole<string>> rolesToDelete = new List<Microsoft.AspNetCore.Identity.IdentityUserRole<string>>();
        List<Microsoft.AspNetCore.Identity.IdentityUserRole<string>> newRolesToInsert = new List<Microsoft.AspNetCore.Identity.IdentityUserRole<string>>();
        ...
        foreach (var roleDb in roles)
        {
          foreach (var selectedRole in selectedRoles)
          {
            if (roleDb.Id.Equals(selectedRole.Id))
            {
              ...
              {
                // add
                newRolesToInsert.Add(new Microsoft.AspNetCore.Identity.IdentityUserRole<string> { UserId = model.Id, RoleId = selectedRole.Id });
              }
            }
          }
        }
        ...
        foreach (var userRole in userRoles)
        {
          foreach (var unselectedRole in unselectedRoles)
          {
            ...
            {
              // roles to delete.
              rolesToDelete.Add(new Microsoft.AspNetCore.Identity.IdentityUserRole<string> { UserId = model.Id, RoleId = userRole.RoleId });
            }
          }
        }
    ...
    private IEnumerable<UserRoleCreateViewModel> GetRolesForViewModel(IEnumerable<Microsoft.AspNetCore.Identity.IdentityRole> roles)
    {
    ...
    /// <param name="roles">The roles.</param>
    /// <returns>List of type <see cref="UserRoleCreateViewModel"/>.</returns>
    private IEnumerable<UserRoleCreateViewModel> GetUserRolesForEditViewModel(IEnumerable<Microsoft.AspNetCore.Identity.IdentityRole> userRoles, IEnumerable<Microsoft.AspNetCore.Identity.IdentityRole> roles)
    {
